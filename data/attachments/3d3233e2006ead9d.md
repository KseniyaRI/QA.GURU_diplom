...
Expected: 200
Received: 400
    at /Users/kryabukhin001/Documents/QA.GURU/QA.GURU_diplom/specs/api.spec.js:99:41
```
...
```ts
   ...
   94 |           "reportingStandardIds": "1c892dcb-3b2c-4cc0-9869-c8152eb8c76a",
   95 |           "departmentId": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
   96 |           "financialYear": 2026
   97 |         }
   98 |       });
>  99 |       expect(entitiesResponse.status()).toBe(200);
      |                                         ^ Error: expect(received).toBe(expected) // Object.is equality
  100 |
  101 |     });
  102 |
  103 |     //test('Получение пагинированной истории действий c Engagment', async ({ request }) => {
  104 |
  105 | //});
  106 | });
  107 |
