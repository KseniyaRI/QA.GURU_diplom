...
Expected substring: "TRTatiana Rusanova"
Received string:    "Tatiana Rusanova"
    at /Users/kryabukhin001/Documents/QA.GURU/QA.GURU_diplom/specs/pages.spec.js:68:38
```
...
> 68 |         expect(dropDownUserDataText).toContain(usernameButtonText);    
     |                                      ^ Error: expect(received).toContain(expected) // indexOf
  69 |     });
  70 | });
  71 |
