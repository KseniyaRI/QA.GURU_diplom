...
Received has value: "4ed1fcb3-96ad-4a2f-be79-2fda08f90544"
    at /Users/kryabukhin001/Documents/QA.GURU/QA.GURU_diplom/specs/api.spec.js:110:50
```
...
```ts
  ...
  108 |
  109 |       // проверяем, что объект ответа содержит все поля из объекта запроса
> 110 |       expect(updateEngagment.data.department.id).toMatchObject({
      |                                                  ^ Error: expect(received).toMatchObject(expected)
